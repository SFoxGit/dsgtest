...
export default function OffHand() {
  ...
  const weaponOptions = Object.keys(data.Back_Hand)
  ...
  const weaponColorOptions = data.Back_Hand[weapon]
    ...
    <StyledContainer expand={showOffHand}>
      <Grid container>
        ...
        <Grid item xs={3}>
          <Switch
            ...
            inputProps={{ 'aria-label': 'off hand switch' }}
          />
        </Grid>
        <Grid item xs={3}>
          {checked && (
            <Button onClick={() => setShowOffHand(!showOffHand)}>
              {showOffHand ? (
      ...
      {showOffHand && (
        <>
          ...
          <SelectorComponent
            index={weaponIndex}
            assetOptions={weaponOptions}
            setAsset={setWeapon}
            asset={weapon}
            labelText='Options'
          />
          <SelectorComponent
            index={weaponColorIndex}
            assetOptions={weaponColorOptions}
            setAsset={setWeaponColor}
            asset={weaponColor}
          ...
          <SelectorComponent
            index={sleeveIndex}
            assetOptions={sleeveOptions}
            setAsset={setSleeve}
            asset={sleeve}
            labelText='Sleeve'
          />
          <SelectorComponent
            index={sleeveColorIndex}
            assetOptions={sleeveColorOptions}
            setAsset={setSleeveColor}
            asset={sleeveColor}
            labelText='Sleeve Color'
          />
        </>
      )}
    </StyledContainer>
