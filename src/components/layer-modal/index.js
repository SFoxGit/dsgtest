...
export default function Layer({ showLayer, setShowLayer }) {
  ...
  const updateLayers = () => {
    ...
    addLayer({ layerType: layer, assetName: newAsset, color: randomColor, isOpen: true, isLocked: false, display: true})
    setShowLayer(false)
  }
  return (
